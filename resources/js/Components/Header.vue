            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center">
                  <div class="flex items-center ms-3">
                    <span class="font-montserrat">Diseño y desarrollo científico de alto nivel</span>
                  </div>
                </div>
            </div>
          </div>
                 ...
                 <li>
                    <Link
                        ...
                        class="
                            ...
                            py-2
                            px-2
                            flex items-center p-2 text-gray-900 rounded-lg light:text-white hover:bg-gray-100 light:hover:bg-gray-700 group
                        "
                    >
