            ...
            <div class="w-full flex flex-col md:flex-row py-6">
                <div class="flex-1 mb-6">
                    <a class="text-orange-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="/">
                        <img :src="`storage/images/Logo-Quimiecologi-01.png`" class="w-50 inline-block"
                ...
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="font-light no-underline hover:underline text-gray-800 hover:text-orange-500">
                                FAQ
                            </a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                ...
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        ...
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="https://ve.linkedin.com/company/laboratorio-quimiecologi-c-a-l%C3%ADnea-facial-bastt%C2%AE"
