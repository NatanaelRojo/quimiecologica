<template>
    <div role="alert">
        <button data-dismiss="alert" aria-label="Cerrar" @click.prevent="handleClearErrorsClick"
        ...
        <ul>
            <li class="relative block w-full p-4 mb-4 text-base leading-5 text-white bg-red-500 rounded-lg opacity-100 font-regular"
                v-for="(error, index) in errors" key="index">{{ error }}</li>
        </ul>
    </div>
</template>
