...
<template>
    ...
    <nav class="relative container mx-auto p-6">
        ...
        <div class="flex items-center justify-between">
            <!-- Logo -->
            <div class="pt-2">
            <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/logo.svg" alt="" />
            </div>
            <!-- Menu Items -->
    ...
    <section id="hero">
        ...
        >
            ...
            >
                Bring everyone together to build better products {{ message }}
            </h1>
            ...
            <!-- Image -->
            <div class="md:w-1/2">
            <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/illustration-intro.svg" alt="" />
            </div>
        </div>
    </section>
    ...
    <section id="testimonials">
        ...
        <div class="max-w-6xl px-5 mx-auto mt-32 text-center">
            ...
            >
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/avatar-anisha.png" class="w-16 -mt-14" alt="" />
            ...
            >
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/avatar-ali.png" class="w-16 -mt-14" alt="" />
            ...
            <div
                class="hidden flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:flex md:w-1/3"
            >
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/avatar-richard.png" class="w-16 -mt-14" alt="" />
    ...
    <footer class="bg-veryDarkBlue">
        ...
        >
            ...
            <!-- Logo -->
            <div>
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/logo-white.svg" class="h-8" alt="" />
            </div>
            <!-- Social Links Container -->
            <div class="flex justify-center space-x-4">
                <!-- Link 1 -->
                <a href="#">
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/icon-facebook.svg" alt="" class="h-8" />
                </a>
                <!-- Link 2 -->
                <a href="#">
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/icon-youtube.svg" alt="" class="h-8" />
                </a>
                <!-- Link 3 -->
                <a href="#">
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/icon-twitter.svg" alt="" class="h-8" />
                </a>
                <!-- Link 4 -->
                <a href="#">
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/icon-pinterest.svg" alt="" class="h-8" />
                </a>
                <!-- Link 5 -->
                <a href="#">
                <img src="https://raw.githubusercontent.com/bradtraversy/tailwind-landing-page/main/img/icon-instagram.svg" alt="" class="h-8" />
                </a>
            </div>
            </div>
            <!-- List Container -->
